...
export async function hasEmailMarketingConsent(/** @type {string} */ email) {
    ...
    try {
        ...
        // console.log(`🎟️[PROMO] email consent check: ${trimmed} -> subscribed=false contactsExt=${viaExt.detail} marketing=${viaMarketing.detail} api=${viaApi.detail} contacts=${viaContacts.detail}`);
        return false;
    } catch (err) {
