...
$w.onReady(async () => {
    ...
    $w('#section30').onViewportLeave((event) => {
        $w('#scrollToTopCon').show('slide')
    })

    $w('#section30').onViewportEnter((event) => {
        $w('#scrollToTopCon').hide('slide')
    })

    $w('#scrollToTopCon').onClick((event) => {
